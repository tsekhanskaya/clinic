...
class MedicalReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create medical_report' do
    assert_difference('MedicalReport.count') do
      post medical_reports_url,
           params: { medical_report: { data_examination: @medical_report.data_examination, prescribing: @medical_report.prescribing, recommendation: @medical_report.recommendation, sick_leave: @medical_report.sick_leave } }, as: :json
    end
  ...
  test 'should update medical_report' do
    patch medical_report_url(@medical_report),
          params: { medical_report: { data_examination: @medical_report.data_examination, prescribing: @medical_report.prescribing, recommendation: @medical_report.recommendation, sick_leave: @medical_report.sick_leave } }, as: :json
    assert_response :success
  end
